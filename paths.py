...
# Dataset roots
EGOLIFE_ROOT = "/home/aniket/EgoLife"  # path to EgoLife dataset root (https://huggingface.co/datasets/lmms-lab/EgoLife)
VIDEO_MME_ROOT = "/home/aniket/Video-MME"  # path to VideoMME dataset root (https://huggingface.co/datasets/lmms-lab/Video-MME)
MODEL_ROOT = EGAGENT_ROOT  # path containing multimodal embedding model

# API key file locations
GOOGLE_GENAI_KEY_PATH = "google-genai-key.txt"
OPENAI_API_KEY_PATH = "openai-api-key.txt"
